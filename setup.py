...
plugin_identifier = "i2ctempcontrol"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_i2ctempcontrol"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-I2ctempcontrol"
...
# module
plugin_description = """Uses a LM75 and GPIO to control the temperature of the chamber using an exhaust fan and small heater."""
